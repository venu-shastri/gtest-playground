...
#include <gtest/gtest.h>
//Happy Path
TEST(VitalsOkTest, AllVitalsNormal_ReturnsOk) {
    EXPECT_EQ(vitalsOk(98.6f, 72.0f, 98.0f), 1);
}
//Temperatre Rekated Tests
TEST(VitalsOkTest, TemperatureTooHigh_ReturnsNotOk) {
  
    
  //Arrange
  float temperature=103.0f;
  float pulse=72.0f;
  float spo2=98.0f;
  int expected=0;
  //Act
